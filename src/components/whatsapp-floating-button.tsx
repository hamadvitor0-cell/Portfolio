...
export function WhatsappFloatingButton() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-4 z-50 inline-flex size-14 items-center justify-center rounded-full border border-white/20 bg-gradient-to-br from-accent to-foreground text-background shadow-[0_18px_45px_rgb(var(--color-accent)/0.35)] transition duration-300 hover:-translate-y-1 hover:scale-105 hover:shadow-[0_22px_60px_rgb(var(--color-accent)/0.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:bottom-6 sm:right-6"
    >
