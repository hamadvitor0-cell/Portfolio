...
export function WhyWorkSection() {
  return (
    <section id="why" className="px-4 py-8 sm:px-6">
          ...
          {reasons.map((reason, index) => {
            ...
            return (
              <SectionReveal key={reason.title} delay={index * 0.05}>
                <article className="group h-full rounded-[1.2rem] border border-white/10 bg-white/[0.035] p-5 transition duration-300 hover:-translate-y-1 hover:border-[#7c6cff]/50 hover:bg-white/[0.055]">
